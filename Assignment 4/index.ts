...
let numX = 9; //Determine if Even or odd
...
let score: number = 75; // Grading System
let grade: string; // string variable to assign grade
grade =
  score >= 90
    ? "Your Grade is A" //condition to assign A grade
    : score >= 80
    ? "Your Grade is B" //condition to assign B grade
    : score >= 70
    ? "Your Grade is C" //condition to assign C grade
    : score >= 60
    ? "Your Grade is D"
    : "Your Grade is F"; // condition to assign D grade or else F grade.
...
let tempFahrenheit = 70; //declaring a variable for Fahrenheit value
...
let numY = -65; //declaring a variable to check if a number is positive, negative or zero.
if (numY > 0) {
...
let givenNumber = 5; //Multiplication table for any given number upto 10.
